...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            yield driver.get('https://meet.google.com/nqr-zcfg-rvw');
            ...
            buttonInput.click();
            yield driver.wait(selenium_webdriver_1.until.elementLocated(selenium_webdriver_1.By.id('456vtr56465')), 1000000);
        }
        finally {
            yield driver.quit();
        }
